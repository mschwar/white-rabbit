...
| --- | --- | --- | --- |
| `DISCOVER` | Surface broad yet relevant candidates from a natural-language target. | Decompose the target, spawn parallel discoverers where safe, aggregate, dedupe, preliminarily triage, and log source diversity. | 50+ categorized candidates in under 25 seconds where the market supports it; source diversity at least 5; full provenance on surfaced candidates. |
