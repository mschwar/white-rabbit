...
- Branch: `fix/rg6r4-required-suite-contact-precision`.
- Status: still `qa_failed`; do not merge until Prompt B reruns on the updated branch and passes.
