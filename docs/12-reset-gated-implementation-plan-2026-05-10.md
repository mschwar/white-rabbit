...
**Next Prompt A feature:** `R12 - Evidence dossier review mode` is ready on `feat/reset-r12-evidence-dossier-review`.
**Current Prompt B handoff:** None. R11 passed Prompt B QA and is ready to merge to `rebuild/validated-leads-loop`; R12 is now the next Prompt A feature. Keep RG5/RG6/export/dogfood/main blocked.
...
A refreshed RG4 design preflight artifact exists under `docs/mockups/rg4-refreshed-preflight-2026-05-12/` with six rendered mockup screens. Matt approved this artifact on 2026-05-12. It initially unlocked R10 only; after R10 Prompt B, R11 was ready. R11 has now passed Prompt B QA and is `merged_to_rebuild_branch`. R12 is now ready. Export, persistence, dogfood, and `main` promotion remain blocked until their documented prerequisites pass.
...
| R12 | Evidence dossier review mode | ready | `feat/reset-r12-evidence-dossier-review` | browser |
...
- Queue consequence: R11 is `merged_to_rebuild_branch` on `feat/reset-r11-crm-results-table`; R12 is `ready` on `feat/reset-r12-evidence-dossier-review`.
