...
**Current Prompt B handoff:** None. R08 passed Prompt B QA and is merged to `rebuild/validated-leads-loop`; R09 is the next same-gate Prompt A feature. Do not touch `main`.
