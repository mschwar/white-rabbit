...
**Next Prompt A feature:** None. R00 is implemented on `feat/reset-r00-w5-hold-control` and awaits Prompt B QA/merge before any downstream Prompt A assignment is valid.
