...
- Per-recipe scoreboard: API cost spent, leads returned, usable count, **minutes per usable lead**, **API cost per usable lead**.
- Sort-by-score controls in the lead view (sort by Fit, Evidence, Contact, or pass/fail gate).
