    ...
    <main className="min-h-screen bg-zinc-950 px-6 py-10 text-zinc-50">
      <section className="mx-auto flex w-full max-w-6xl flex-col gap-8 rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-black/20 backdrop-blur sm:p-10">
        ...
        <div className="rounded-3xl border border-amber-400/30 bg-amber-400/10 p-5 text-amber-50">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-amber-200">Internal evaluation only</p>
          <p className="mt-2 max-w-3xl text-sm leading-6 text-amber-100">
            This route stays out of the primary operator flow while the launch gate is red. Use it only for Matt-run recipe review and internal evaluation, not for Thomas or Lee daily prospecting.
          </p>
        </div>
